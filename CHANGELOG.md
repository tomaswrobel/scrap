...
- Using oxc instead of swc as it is faster
...
- Better Paint editor via [painterro](https://github.com/)
- Adopting the new guidelines and coding style (Internal standard)
