...
- **SB3 Support** \[_incomplete_\] - Scrap supports the SB3 file format, which is the default file format used by Scratch 3.0. This allows you to import your Scratch projects into Scrap and continue working on them.
...
| [Node](https://nodejs.org)                                   | Found in `.nvmrc`                                        |
| [yarn](https://yarnpkg.com/)                                 | Found in `package.json`, in the `"packageManager"` field |
| [Rust](https://rust-lang.org/)                               | 1.90.x                                                   |
| [wasm-pack](https://github.com/drager/wasm-pack)             | 0.x                                                      |
| [wasm-bindgen](https://github.com/wasm-bindgen/wasm-bindgen) | 0.x                                                      |
| [VS Code](https://code.visualstudio.com/)                    | any, with recommended extensions                         |
...
3. Install front-end dependencies: `yarn install`
...
**Google**: Scrap wouldn't be possible without **Blockly**. (In fact, Scratch relies on Blockly too.) When used to develop at school, I used a **Chromebok** to take notes and, when the teacher isn't looking, to code Scrap.
