...
class LanguageServiceDefaultsImplementation implements LanguageServiceDefaults {
	...
	public addExtraLib(content: string, _filePath?: string): IDisposable {
		let filePath: string;
	...
	public setWorkerOptions(options: WorkerOptions): void {
		this._workerOptions = options || Object.create(null);
		this._onDidChange.fire(undefined);
	}

	public setInlayHintsOptions(options: InlayHintsOptions): void {
